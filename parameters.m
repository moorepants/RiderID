...
%         mod(03).X0 = [ 33.3007         0   30.8426    0.2080    7.3363  193.9814   -3.0056         0];
%         mod(04).X0 = [ 40.5795         0   31.0517   -0.2931         0  192.5890   -3.8244         0];
%         mod(05).X0 = [ 41.5111         0   28.2233         0         0  177.4519   -3.1869         0]; % based on v=3
